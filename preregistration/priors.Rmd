...
renv::use(lockfile = here::here("renv.lock"),
          "ggplot2",
          "dplyr",
          "gt",
          "bayesmeta",
...
m_sari_optimistic_sari =
  ...
  formula = mf,
  prior = priors +
    brms::prior(normal(-0.04879016, 0.09303989), class = "b", coef = "interventionsarilumab"),
...
m_bari_optimistic_bari =
  ...
  formula = mf,
  prior = priors +
    brms::prior(normal(-0.1053605, 0.2009161), class = "b", coef = "interventionbariticinib"),
